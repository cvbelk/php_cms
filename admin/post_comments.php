...
<?php
    ...
    $query = "SELECT * FROM comments WHERE comment_post_id = {$post_id} "; // 'LIMIT 3' limited to 3 
...
<?php           
        ...
        print "<td> <a href='post_comments.php?approve={$comment_id}&p_id={$post_id}'>Approve</a> </td>";
        print "<td> <a href='post_comments.php?unapprove={$comment_id}&p_id={$post_id}'>Unapprove</a> </td>";
        print "<td> <a href='post_comments.php?delete={$comment_id}&p_id={$post_id}'>Delete</a> </td>";
