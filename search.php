    ...
    if (isset($_POST['search'])) {
       ...
       if ($count == 0) {
        ...
        ?>
              ...
              Search for:  <?php echo $search; ?><br>
              <small><?php echo $count; ?> posts found</small>
              </h1>
        <?php      
...
?>
                ...
                <p class="lead">
                    by <a href="/cms/author_posts/<?php echo $post_author;?>/<?php echo $post_id;?>"><?php echo $post_author; ?></a>
                </p>
